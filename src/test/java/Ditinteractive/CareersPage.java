	...
	public class CareersPage{
	    ...
	    @Test(priority = 2)
	    	...
	    	public void navigateToCareersPage() throws InterruptedException {
	            ...
	            WebElement CareersMenu = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[@id='menu-item-23397']//a")));
	            Actions actions = new Actions(driver);
	            actions.moveToElement(CareersMenu).perform();
	            System.out.println("Hovered over the Careers Menu.");
