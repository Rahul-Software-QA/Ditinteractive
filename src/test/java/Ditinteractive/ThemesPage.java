...
import org.testng.annotations.AfterClass;
	...
	public class ThemesPage{
	    ...
	    @Test(priority = 2)
	    	...
	    	public void navigateToThemesPage() throws InterruptedException {
	            // Hover over the "About" menu item
	            WebElement ThemesMenu = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[@id='menu-item-23537']//a[@target='_blank']")));
	            Actions actions = new Actions(driver);
	            actions.moveToElement(ThemesMenu).perform();
	            System.out.println("Hovered over the Themes Menu.");

	            // Click on "About" button
	            ThemesMenu.click();
	            Thread.sleep(5000);
	            System.out.println("Navigated to Themes Page.");
	            
	            // Perform continuous scroll
	            continuousScroll("Themes");
